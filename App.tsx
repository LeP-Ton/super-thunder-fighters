      ...
      <div className="relative">
        ...
        {status === GameStatus.GAMEOVER && (
          <div className="absolute inset-0 bg-rose-950/90 backdrop-blur-lg flex flex-col items-center justify-center rounded-xl p-8 text-center z-50">
            ...
            <div className="flex flex-col gap-3">
              ...
              <button onClick={returnToHome} className="flex items-center justify-center gap-3 px-10 py-4 bg-slate-800 hover:bg-slate-700 text-slate-100 font-bold rounded-full border border-slate-700"><Terminal className="w-5 h-5" /> {t.backHome}</button>
            </div>
          </div>
        )}
        ...
        {status === GameStatus.PAUSED && (
          <div className="absolute inset-0 bg-slate-950/90 backdrop-blur-lg flex flex-col items-center justify-center rounded-xl p-8 text-center z-40">
            ...
            <p className="text-slate-400 mb-8 max-w-sm">{t.subtitle}</p>
            <div className="flex flex-col gap-3">
              <button onClick={() => setStatus(GameStatus.PLAYING)} className="flex items-center justify-center gap-3 px-10 py-4 bg-sky-600 hover:bg-sky-500 text-white font-bold rounded-full transform hover:scale-110"><Play className="w-5 h-5 fill-current" /> {t.resume}</button>
              <button onClick={returnToHome} className="flex items-center justify-center gap-3 px-10 py-4 bg-slate-800 hover:bg-slate-700 text-slate-100 font-bold rounded-full border border-slate-700"><Terminal className="w-5 h-5" /> {t.backHome}</button>
            </div>
          </div>
        )}
